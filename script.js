...
const gymMap=new Image();gymMap.src='assets/gym_reception.svg?v=15';
...
function drawTitle(){
  ...
  rect(72,157,48,39,C.wood2,C.ink,3);px(95,160,2,32,C.gold);rect(36,58,120,30,C.cream,C.ink,3);
  text('500일 꿈속 호텔',96,67,10,C.ink,'center');drawBoyfriend(72,270,'down',0,40);drawYuli(121,270,'down',0,40);
...
function update(dt){
  ...
  const oldX=player.x,oldY=player.y,vx=joy.dx/len,vy=joy.dy/len,speed=72*dt;
